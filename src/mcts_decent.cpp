...
// MCTS_decent
MCTS_decent::MCTS_decent(NeuralNetwork *neural_network, unsigned int thread_num, double c_puct,
...
void MCTS_decent::update_with_move(int last_action)
{
...
std::vector<double> MCTS_decent::get_action_probs(Gomoku *gomoku, double temp)
{
...
void MCTS_decent::simulate(std::shared_ptr<Gomoku> game)
{
